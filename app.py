...
@app.route('/game1')
def game1():
    return redirect("https://www.cybermission.tech/game")

@app.route('/game2')
def game2():
    return redirect("https://phishingquiz.withgoogle.com/")
...
def get_notes():
    ...
    notes_list = [{'id': note.id, 'note': note.note} for note in user_notes]
...
def add_note():
    ...
    new_note = Note(user_id=user_id, note=note_text)
